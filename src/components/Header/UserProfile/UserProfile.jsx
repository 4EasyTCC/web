  // UserProfile/UserProfile.jsx (CORRIGIDO PARA USAR "user")
  ...
  const UserProfile = ({ userData, isScrolled }) => {
    ...
    const handleLogout = () => {
      ...
      // ✅ CORREÇÃO - Remover "user" em vez de "userData"
      ...
      // Forçar atualização do storage event
    ...
    // Gerar avatar com fallback elegante
    const getAvatarUrl = () => {
          ...
          <div className={styles.dropdownMenu}>
            ...
            <div className={styles.dropdownHeader}>
              ...
              <div className={styles.userDetails}>
                <h3 className={styles.userName}>{userData?.nome || 'Usuário'}</h3>
